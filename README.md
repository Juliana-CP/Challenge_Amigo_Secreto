...
- Adicionar nome de amigos: Cria uma lista para adicionar o nome dos amigos que irão participar do sorteio do amigo secreto.

- Sortear amigo secreto: Sorteia entre os nomes de amigos adicionados na lista o nome do amigo secreto de forma aleatória.
